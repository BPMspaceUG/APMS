...
class Table extends RawTable {
    constructor(tablename, SelType = SelectType.NoSelect, callback = function () { }, defaultObj = {}, initFilter = {}) {
        ...
        me.OrderBy = '';
        DB.request('init', { table: tablename, filter: initFilter }, function (resp) {
            if (resp.length > 0) {
